...
import { resumeIcon } from '../constant/data';
    ...
    return (
        <>
            <Box sx={{ py: 5 }}>
                ...
                >
                    <Box sx={{
                        px: 2, display: 'flex', flexDirection: "column", justifyContent: "center",
                    ...
                    <CustomTabPanel value={value} index={1}>
                        <Grid container spacing={2}>
                            <Grid item sm={4} xs={12}>
                                <Typography variant="h5" sx={{textDecoration:'underline'}}>High School</Typography>
                                <Typography>BVIC Shekhanpur </Typography>
                                <Typography>70 %</Typography>
                            </Grid>
                            <Grid item sm={4} xs={12}>
                                <Typography variant="h5" sx={{textDecoration:'underline'}}>Intemediate</Typography>
                                <Typography>BVIC Shekhanpur </Typography>
                                <Typography>56.8 %</Typography>
                            </Grid>
                            <Grid item sm={4} xs={12}>
                                <Typography variant="h5" sx={{textDecoration:'underline'}}>Graduation</Typography>
